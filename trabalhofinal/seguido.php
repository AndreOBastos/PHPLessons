		...
		<div class="container">
			<div class="row">
				...
				<div class="col-xs-8 news-feed">
					<?php 
						$sql = "SELECT usuarios.id, usuarios.login, usuarios.nome, usuarios.avatar FROM usuarios,seguidores WHERE seguidores.idSeguido=usuarios.id AND seguidores.idUsuario=" . $idUsuario;
